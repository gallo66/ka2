...
const imgSet = ()=>{
    ...
    while(a+b+c+d+e !== 15){
        ...
        if      (b !== roopindex && c !== roopindex && d !== roopindex && e !== roopindex && a === 0 && roopindex !== 1){
            a = roopindex;
        }else if(a !== roopindex && c !== roopindex && d !== roopindex && e !== roopindex && b === 0){
            b = roopindex;
        }else if(a !== roopindex && b !== roopindex && d !== roopindex && e !== roopindex && c === 0 && roopindex !== 3){
            c = roopindex;
        }else if(a !== roopindex && b !== roopindex && c !== roopindex && e !== roopindex && d === 0){
            d = roopindex;
        }else if(a !== roopindex && b !== roopindex && c !== roopindex && d !== roopindex && e === 0){
            e = roopindex;
        }
    }
    ...
    while(setindex === secondindex  || setindex === thirdindex || setindex === fourthdindex){
      setindex  = Math.floor(Math.random()*setlistLng);
    }
  

      fourthdindex = thirdindex;
      thirdindex   = secondindex;    
      secondindex  = setindex;    
...
$(function(){
    ...
    $('#js-reslbtn').click(function(){
        ...
        $(this).hide();
        $('.slidebtn').fadeIn(2000);
        $('.targetimg').fadeIn(2000);
